-- Once a merchant records a completed Kaspi refund, an unfulfilled order must
-- leave the work queue. The existing cancellation triggers return stock and
-- raw materials and reverse loyalty; delivered orders retain their history.
