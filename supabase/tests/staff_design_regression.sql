...
begin
 ...
 insert into public.ai_studio_generations(id,tenant_id,requested_by,intent,input_summary,output) values(generation,shop,person,'store_design','Fixture','{"templateKey":"gallery","paletteKey":"mono","heroTitle":"Серик Шоп","heroSubtitle":"Новая коллекция","heroCtaLabel":"В каталог","brandColor":"#ee8899"}');
