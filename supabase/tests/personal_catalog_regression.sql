...
insert into public.ai_studio_generations(id,tenant_id,requested_by,intent,input_summary,output) values ('cb090909-0000-4000-8000-000000000005','cb090909-0000-4000-8000-000000000002','cb090909-0000-4000-8000-000000000001','store_design','Fixture','{"templateKey":"atelier","paletteKey":"mono","heroTitle":"Серик","heroSubtitle":"Коллекция","heroCtaLabel":"Каталог","sections":[{"name":"Одежда"},{"name":"Аксессуары"}],"layout":{"typography":"editorial","hero":"centered","density":"airy","columns":2,"corners":"soft","imageRatio":"portrait"}}');
set local role authenticated;
set local request.jwt.claim.sub='cb090909-0000-4000-8000-000000000001';
select public.create_catalog_setup('cb090909-0000-4000-8000-000000000002','Test','atelier','mono','cb090909-0000-4000-8000-000000000005',null,'{"delivery":true,"pickup":true,"zone":"Алматы","cost":"1500","eta":"Завтра","address":"Алматы, улица 10","hours":"10–20","preparation":"Через 2 часа","gisUrl":"","yandexUrl":""}'::jsonb,'later');
do $$ begin
