...
export function RecordedCommerce(){
  ...
  return <div className={styles.block}>
    <div className={styles.devices}>
      <div className={styles.phone}><video ref={phone} muted autoPlay loop playsInline preload="metadata" aria-label="Запись витрины Dukenim на телефоне"><source src="/design/dukenim-storefront-recording.webm" type="video/webm"/></video></div>
      <div className={styles.desktop}><div className={styles.chrome}><i/><i/><i/><span>Dukenim · Заказы</span></div><video ref={desktop} muted autoPlay loop playsInline preload="metadata" aria-label="Запись рабочего кабинета Dukenim"><source src="/design/dukenim-workspace-recording.webm" type="video/webm"/></video></div>
    </div>
