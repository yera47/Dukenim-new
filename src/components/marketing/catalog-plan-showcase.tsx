...
const plans: Record<Variant, { name: string; monthly: number; description: string; points: string[] }> = {
  start: { name: "Старт", monthly: 24900, description: "Готовая основа, с которой магазин начинает продавать без разового взноса за разработку.", points: ["Шаблоны «Ателье» и «Маркет" + "»", "Готовые палитры и логотип", "Каталог, корзина и заказы"] },
  brand: { name: "Бренд", monthly: 34900, description: "Витрина с собственной подачей, акциями и управляемыми AI-черновиками.", points: ["Шаблоны «Журнал» и «Галерея" + "»", "Точная палитра и бренд-блоки", "Акции, кампании и AI Studio"] },
};
