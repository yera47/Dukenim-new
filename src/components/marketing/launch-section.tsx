...
const moments = [
  ...
  { title: "Соберите свой вид", text: "Загрузите логотип, добавьте товары и выберите палитру. В Brand — настройте расширенные шаблоны, блоки и акции.", icon: Palette },
  { title: "Работайте из одного кабинета", text: "Заказы, остатки и клиенты сохраняют общий контекст. На тарифе Brand доступны расширенные CRM-инструменты.", icon: UsersRound },
] as const;
