    ...
    void (async () => {
      try {
        ...
        if (result.draft) {
          ...
          setCatalogName(saved.catalogName); setBrief(previous => previous || saved.brief); setPaletteKey(saved.paletteKey); setStep(saved.step);
