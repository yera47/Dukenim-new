...
export function CatalogPublication({checks}:{checks:PublicationChecks}){
 ...
 return <details open={error?true:undefined} className="mb-2 overflow-hidden rounded-2xl border border-[#cfd9e4] bg-white shadow-[0_10px_34px_#315f7812]" aria-label="Проверка и публикация">
