...
export function StudioConversation({enabled,onTask,children,dock,onBanner,onAttachment,brandDone=false,deliveryDone=false,builderStage,stageHint,endpoint="/api/ai-studio/draft",staff=false,designOnly=false,working=false}:{enabled:boolean;onTask?:(task:NonNullable<Consultation["task"]>)=>void;children?:React.ReactNode;dock?:React.ReactNode;onBanner?:(brief:string)=>void;onAttachment?:(kind:"photo"|"file"|"camera")=>void;brandDone?:boolean;deliveryDone?:boolean;builderStage?:"setup"|"product";stageHint?:string;endpoint?:string;staff?:boolean;designOnly?:boolean;working?:boolean}) {
