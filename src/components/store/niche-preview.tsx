...
export function NichePreview({ vertical, templateName, background, surface, ink, muted, accent }: {
  ...
  return <div className="niche-preview" style={{ background, color: ink }}>
    <header><b>{preset.storeName}</b><span>{templateName}</span></header>
