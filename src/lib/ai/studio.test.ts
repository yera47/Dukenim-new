...
const design={templateKey:'atelier',paletteKey:'mono',brandColor:'#c04455',heroTitle:'Серик Шоп',heroSubtitle:'Одежда для города',heroCtaLabel:'В каталог',rationale:'Цвет логотипа'};
