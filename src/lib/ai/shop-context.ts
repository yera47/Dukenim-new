...
export function compactShopContext(value:unknown) {
 ...
 return JSON.stringify({
  name:text(root.name,80),catalog_name:text(root.catalog_name,80),business_vertical:text(root.business_vertical,40),catalog_status:text(root.catalog_status,30),merchant_brief:text(root.merchant_brief,300),
