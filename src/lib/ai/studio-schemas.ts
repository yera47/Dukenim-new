...
export const aiStudioDesignSchema = z.object({
  ...
  paletteKey: z.enum(["ink-brass", "paper-forest", "clay-milk", "ocean-sand", "plum-stone", "cobalt-cloud", "olive-linen", "cherry-cream", "terra-charcoal", "mint-charcoal", "rose-ink", "sunset-navy"]),
