...
export const planFeatures: Record<Plan, string[]> = {
  basic: ["Каталог, корзина и заказы", "AI Studio: тексты и структура каталога", "Товары и фотографии без лимита", "Готовые палитры и шаблоны", "Постоянная ссылка dukenim.kz/s/магазин"],
  standard: ["Всё из тарифа «Старт»", "CRM: остатки, клиенты и аналитика", "Точная палитра и расширенные шаблоны", "Акции, бренд-блоки и AI-баннеры", "Расширенная аналитика витрины"],
  pro: ["Всё из тарифа «Старт»", "CRM: остатки, клиенты и аналитика", "Точная палитра и расширенные шаблоны", "Акции, бренд-блоки и AI-баннеры", "Расширенная аналитика витрины"],
};
