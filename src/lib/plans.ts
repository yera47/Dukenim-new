...
export const planFeatures: Record<Plan, string[]> = {
  basic: ["Каталог, корзина и заказы", "AI Studio: создание и оформление магазина", "До 200 товаров", "Свои цвета, логотип и оформление", "Постоянная ссылка dukenim.kz/s/магазин"],
  standard: ["Всё из тарифа «Старт», до 2 000 товаров", "Остатки, клиенты и аналитика", "Точная палитра и расширенные шаблоны", "Акции, бренд-блоки и AI-баннеры", "Расширенная аналитика витрины"],
  pro: ["Всё из тарифа «Старт», до 2 000 товаров", "Остатки, клиенты и аналитика", "Точная палитра и расширенные шаблоны", "Акции, бренд-блоки и AI-баннеры", "Расширенная аналитика витрины"],
};
