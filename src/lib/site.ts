...
export const siteDescription =
  "Dukenim — платформа для розничного бизнеса в Казахстане. Покупатель выбирает и оформляет заказ сам, а владелец ведёт магазин из одного кабинета. 7 дней выбранного тарифа без карты.";
