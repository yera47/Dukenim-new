...
const launchCopy: Record<BusinessVertical, readonly [readonly [string, string], readonly [string, string]]> = {
  fashion: [["Коллекции крупным планом", "Образ бренда, крупные фотографии и переход к коллекциям."], ["Быстрый выбор одежды", "Категории, размеры и ассортимент сразу на первом экране."]],
  beauty: [["Ритуал и история бренда", "Крупная подача линейки, состава и назначения продуктов."], ["Средства по категориям", "Быстрый выбор ухода по задаче или типу продукта."]],
  food: [["Меню с акцентом на блюда", "Крупные фотографии и подборки для первого заказа."], ["Быстрый заказ", "Категории и позиции сразу, без длинной обложки."]],
  flowers: [["Букеты крупным планом", "Эмоциональная обложка и коллекции по поводу."], ["Выбрать и заказать", "Букеты, цена и доступность сразу на первом экране."]],
  services: [["Эксперт и подход", "Сначала доверие, описание результата и ключевые услуги."], ["Услуги и цены", "Понятный список предложений и переход к заявке."]],
  event: [["Афиша и программа", "Главное событие, дата и программа крупным планом."], ["События и билеты", "Ближайшие события и варианты участия сразу."]],
  home: [["Интерьерные коллекции", "Крупная подача пространства, материалов и предметов."], ["Каталог для дома", "Товары по комнатам и категориям на первом экране."]],
  other: [["Обложка и подборки", "Знакомство с магазином и крупная подача товаров."], ["Каталог на первом экране", "Быстрый просмотр ассортимента и категорий."]],
};

export function launchCopyForVertical(vertical: BusinessVertical, index: number) {
  return launchCopy[vertical][index === 0 ? 0 : 1];
}

export const nichePresets: Record<BusinessVertical, NichePreset> = {
  fashion: {
    label: "Одежда", storeName: "Серик Шоп", headline: "Вещи, которые работают вместе.",
  ...
  beauty: {
    label: "Косметика", storeName: "Серик Шоп", headline: "Уход без лишних обещаний.",
  ...
  food: {
    label: "Еда", storeName: "Серик Шоп", headline: "Свежая еда. Понятный заказ.",
  ...
  flowers: {
    label: "Цветы", storeName: "Серик Шоп", headline: "Букеты к нужному моменту.",
  ...
  services: {
    label: "Услуги", storeName: "Серик Шоп", headline: "Услуги и условия — в одной ссылке.",
  ...
  event: {
    label: "Мероприятия", storeName: "Серик Шоп", headline: "Программа и билеты в одной ссылке.",
  ...
  home: {
    label: "Интерьер", storeName: "Серик Шоп", headline: "Предметы для спокойного дома.",
  ...
  other: {
    label: "Другое", storeName: "Серик Шоп", headline: "Ваш ассортимент — в понятном порядке.",
