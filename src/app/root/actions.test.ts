...
import { createStore, updateStore, completeRequest, createPromotion, togglePromotion, updateCrmIntegrationStatus, updateRootProduct, setRootStaffAccess, cancelRootUnpaidOrder, setRootCatalogPublication, correctRootStock } from "./actions";
...
describe("root mutations", () => {
  ...
  it.each([createStore, updateStore, completeRequest, createPromotion, togglePromotion, updateCrmIntegrationStatus, updateRootProduct, setRootStaffAccess, cancelRootUnpaidOrder, setRootCatalogPublication, correctRootStock])("rejects a local demo session before constructing a privileged client", async action => {
