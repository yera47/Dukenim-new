...
import {AccountAccessForm} from "./access-form";
...
export default async function RootAccountsPage({ searchParams }: PageProps) {
  ...
  return <main className="min-h-screen bg-[var(--surface)] px-4 py-10"><div className="mx-auto max-w-6xl">
    ...
    <p className="muted mt-4 text-sm">Показаны первые 1000 аккаунтов. Блокировка новых входов доступна с записью причины; уже действующие сессии не отзываются мгновенно. Смена глобальных ролей пока недоступна.</p>
  </div></main>;
}
