...
type Props = { slug: string; deliveryEnabled: boolean; pickupEnabled: boolean; pickupLocation?: unknown; minOrder: number; zones: CheckoutZone[]; demo?: boolean; phoneAuthAvailable?: boolean; kaspiRemoteEnabled?:boolean; kaspiRemoteLinkAvailable?:boolean };
...
export function CheckoutClient({ slug, deliveryEnabled, pickupEnabled, pickupLocation, minOrder, zones, demo = false, phoneAuthAvailable = false, kaspiRemoteEnabled=false, kaspiRemoteLinkAvailable=false }: Props) {
