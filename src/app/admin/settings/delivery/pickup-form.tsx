  ...
  return <section className="space-y-4 rounded-2xl border p-5">
    ...
    <form action={action} className="space-y-4">
      <fieldset disabled={pending} className="space-y-4">
        ...
        <p className="text-sm">Откройте точку в Яндекс Картах → «Поделиться» → «Скопировать ссылку». Для карты на сайте можно вставить весь код виджета: мы извлечём безопасную ссылку сами. Адрес проверьте перед сохранением.</p>
