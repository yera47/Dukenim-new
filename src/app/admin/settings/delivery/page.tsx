...
export default async function DeliverySettings() {
  ...
  return <main className="mx-auto max-w-3xl space-y-5">
    ...
    <p className="rounded-2xl border border-blue-200 bg-blue-50 p-4 text-sm text-blue-950"><b>Курьер через Яндекс — вручную:</b> покупатель оставит телефон и точный адрес, увидит только цену товаров и подтвердит переменную стоимость доставки. Заказ придёт вам; свяжитесь с покупателем, согласуйте цену и сами оформите курьера от двери до двери удобным вам способом. Интеграция и ключ Яндекса в Dukenim не нужны. Не включайте этот способ, если не сможете организовать курьера для выбранной зоны.</p>
