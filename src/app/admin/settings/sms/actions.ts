...
export async function saveSmsSettings(_:SmsActionState,form:FormData):Promise<SmsActionState>{
 ...
 if(error)return{error:"Настройки не сохранены. Попробуйте ещё раз."};revalidatePath("/admin/settings/sms");return{success:"Настройки сохранены. Если имя новое, команда Dukenim проверит его и зарегистрирует у SMS-провайдера."};
}
