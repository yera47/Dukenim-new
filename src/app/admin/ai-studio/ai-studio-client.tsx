...
type Design = { colorTheme?: {background:string;surface:string;accent:string}; brandColor?: string; templateKey: string; paletteKey: string; heroTitle: string; heroSubtitle: string; heroCtaLabel: string; rationale: string };
