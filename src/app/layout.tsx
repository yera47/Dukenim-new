...
export const metadata:Metadata={metadataBase:new URL(process.env.NEXT_PUBLIC_SITE_URL??"http://localhost:3000"),title:{default:"Dukenim — платформа для магазинов",template:"%s · Dukenim"},description:"Онлайн-витрина, товары, склад, заказы и аналитика в одной платформе.",applicationName:"Dukenim"};
