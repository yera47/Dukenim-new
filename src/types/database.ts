...
type TenantRow={id:string;slug:string;custom_domain:string|null;name:string;tagline:string|null;logo_url:string|null;accent_color:string;city:string|null;phone:string|null;whatsapp:string|null;instagram:string|null;plan:"basic"|"standard"|"pro";next_plan:"basic"|"standard"|"pro"|null;status:"active"|"paused"|"trial";trial_ends_at:string|null;onboarding_completed:boolean;created_at:string};
